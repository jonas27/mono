...
import 'package:wedding/galleryPager.dart';
import 'package:wedding/galleryPicture.dart';
...
class GalleryState extends State<Gallery> {
    ...
    for (int i =0; i<widget.pictureUris.length; i++) {
      list.add(
        GestureDetector(
          ...
          child: GalleryPicture(pictureWidth: widget.pictureWidth, pictureHeight: widget.pictureHeight,URI: widget.pictureUris[i],)
        )
      );
    }
    return list;
  ...
  _showFullScreen(int i) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => GalleryPager(pictureUris: widget.pictureUris,initialItem: i,)),
